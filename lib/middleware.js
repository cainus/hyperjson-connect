...
var send = function(req, res, jsonObj, shouldAddDefaultLinks) {
  ...
  return res.send(JSON.stringify(jsonObj.toObject()));
};
...
var factory = function(options){
  options = options || {};
  addDefaultLinks = options.defaultLinks || true;
  objectName = options.objectName || "object";
  collectionName = options.collectionName || "collection";
